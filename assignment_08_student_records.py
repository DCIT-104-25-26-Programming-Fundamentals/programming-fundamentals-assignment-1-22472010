...
def add_student(students):
    ...
    for i in range(1, num_scores + 1):
        try:
            ...
            # Format clean integers if there are no decimals
            if score.is_integer():
                score = int(score)
            scores.append(score)
        except ValueError:
...
def display_all_students(students):
    """Prints a formatted table displaying all student records."""
    if not students:
    ...
    for student in students:
        ...
        print(f"{student['name']:<15}{student['id']:<12}{scores_str:<15}{avg:<8.2f}")
